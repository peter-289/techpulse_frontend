...
Reference request and response contracts for project management endpoints.

## Overview

This section explains how to work with **API Reference** in the Tech Pulse platform.
...
Use this when:
- Use this when implementing strongly typed API clients.
