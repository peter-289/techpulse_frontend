...
Receive real-time events for uploads, project status changes, and scans.

## Overview

This section explains how to work with **Webhooks** in the Tech Pulse platform.
...
Use this when:
- Use this when you need event-driven automation.
